# Generated by Django 5.0.7 on 2024-11-10 03:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('REGULAR', 'Regular User'), ('ENGINEER', 'Engineer')], default='REGULAR', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_engineer', models.ForeignKey(blank=True, limit_choices_to={'user_type': 'ENGINEER'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='assigned_tickets', to=settings.AUTH_USER_MODEL)),
